@extends('layout.layout', ['kkLink' => 'dis-sovet/documents', 'ruLink' => 'dis-sovet/documents', 'enLink' => 'dis-sovet/documents'])
    ...
    <main class="main">
        <div class="container">
            <div class="main_inner">
                ...
                <div class="content">
                    <h1 class="heading">Документы диссертационного совета</h1>
                    <div class="documents">
