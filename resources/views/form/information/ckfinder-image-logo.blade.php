<div>
  ...
  <input type="hidden" name="logo" value="{{old('logo') ?? $model->logo}}" data-id="custom-ckfinder-upload" id="">
  <div style="margin-top: 15px;">
    <img src="{{old('logo') ?? $model->logo}}" id="custom-ckfinder-upload-img" style="max-width: 500px" alt="">
  </div>

  @if(count($errors->get($path = str_replace([']', '['], ['', '.'], 'logo')))> 0)
